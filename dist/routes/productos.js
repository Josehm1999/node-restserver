...
router.get('/:id', [
    ...
    (0, express_validator_1.check)('id', 'El producto no existe').custom(helpers_1.dbValidators.existeProductoById),
...
router.post('/', [
    ...
    (0, express_validator_1.check)('categoria').custom(helpers_1.dbValidators.existeCategoriaById),
    middlewares_1.validarCampos
